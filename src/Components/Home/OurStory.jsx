            ...
            <section>
                <div className="bg-[#A5CCFF] mt-10">
                    <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 text-white">
                        ...
                        <p className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl text-black ">Welcome to MedCareHub, where health and well-being converge with cutting-edge medical solutions.We are dedicated to revolutionizing healthcare by providing access to innovative and reliable medical information and products.</p>
                ...
                <img src={img} alt="" className="lg:w-[900px] mx-auto mb-12 -mt-20 rounded-lg shadow-md lg:-mt-40 " />
            </section>
        </div>
    );
};
