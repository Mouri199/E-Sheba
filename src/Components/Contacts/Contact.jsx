                        ...
                        <form onSubmit={sendEmail}>
                            <div className="   bg-gray-200 pt-6 pb-5 max-w-[500px] px-2">
                                <div >
                                    ...
                                    <p className="md:text-sm text-blue-700 text-[12px] font-bold pl-4">
                                ...
                                <div className="relative flex flex-col pl-4 px-2 pt-4">
                                    ...
                                    <input name="form_email" className="w-full max-w-[400px]  bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" type="email" id="" />
                                </div>
                                <div className="relative flex flex-col pl-4 px-2 pt-4 ">
                                    <label
                                        htmlFor="department"
